...
const password1 = bcrypt.hashSync('111111', 10)
const password2 = bcrypt.hashSync('222222', 10)
...
db.once('open', () => {
  ...
  user2.save().then(user => {
    Restaurants.create({
      ...
      rating: '4.2',
      description:
        '從味蕾開始，重拾美味感s動。艾朋牛排餐酒館對高級料理的細選珍饌堅持，更勇於翻脫新意，要以平易親人的親切風格，同時不失料理獨家精髓，成功打動每吋挑剔味蕾，讓每位顧客享用鮮嫩Steak牛排風采，咀嚼Pasta義大利麵層次風味！',
      userId: user._id
    })
